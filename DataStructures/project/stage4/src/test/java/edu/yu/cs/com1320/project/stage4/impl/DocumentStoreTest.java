...
public class DocumentStoreTest{
	...
	public void putLimitTest() throws java.io.FileNotFoundException, java.net.URISyntaxException, java.io.IOException, IllegalStateException{
		...
		URI uriTest = uriCreate("http://java.sun.com/j2se/1.3/");
		assert(this.docStoreTest.get(uriTest)!=null);
		this.docStoreTest.setMaxDocumentCount(1);
		assert(this.docStoreTest.get(uriTest)==null);
		assertThrows(IllegalStateException.class,()->{
			this.docStoreTest.undo(uriTest);
		});
	}

	public void deleteCommandsLimitTest() throws java.io.FileNotFoundException, java.net.URISyntaxException, java.io.IOException, IllegalStateException{
		putInitialize();
		URI uriTest = uriCreate("http://java.sun.com/j2se/1.3/");
